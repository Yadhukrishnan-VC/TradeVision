...
VALID_TOKEN = "test_ta_token_456"
TEST_URL_CONF = "apps.technical_analysis.tests.test_urls"
...
def _get_url(token: str = VALID_TOKEN) -> str:
    return f"/api/v1/technical-analysis/webhooks/tradingview/{token}/"


class TestTradingViewTAWebhookEndpoint:
    def test_happy_path_returns_202(self, api_client, db) -> None:
        with override_settings(
            ROOT_URLCONF=TEST_URL_CONF,
            TRADINGVIEW_TA_WEBHOOK_TOKEN=VALID_TOKEN,
        ):
            payload = {
                "ticker": "RELIANCE",
                "close": 2850.50,
    ...
    def test_persists_snapshot_in_database(self, api_client, db) -> None:
        with override_settings(
            ROOT_URLCONF=TEST_URL_CONF,
            TRADINGVIEW_TA_WEBHOOK_TOKEN=VALID_TOKEN,
        ):
    ...
    def test_invalid_token_returns_401(self, api_client, db) -> None:
        with override_settings(
            ROOT_URLCONF=TEST_URL_CONF,
            TRADINGVIEW_TA_WEBHOOK_TOKEN=VALID_TOKEN,
        ):
    ...
    def test_invalid_json_returns_400(self, api_client, db) -> None:
        with override_settings(
            ROOT_URLCONF=TEST_URL_CONF,
            TRADINGVIEW_TA_WEBHOOK_TOKEN=VALID_TOKEN,
        ):
    ...
    def test_non_dict_json_returns_400(self, api_client, db) -> None:
        with override_settings(
            ROOT_URLCONF=TEST_URL_CONF,
            TRADINGVIEW_TA_WEBHOOK_TOKEN=VALID_TOKEN,
        ):
    ...
    def test_pine_metadata_preserved(self, api_client, db) -> None:
        with override_settings(
            ROOT_URLCONF=TEST_URL_CONF,
            TRADINGVIEW_TA_WEBHOOK_TOKEN=VALID_TOKEN,
        ):
    ...
    def test_raw_payload_preserved_verbatim(self, api_client, db) -> None:
        with override_settings(
            ROOT_URLCONF=TEST_URL_CONF,
            TRADINGVIEW_TA_WEBHOOK_TOKEN=VALID_TOKEN,
        ):
    ...
    def test_not_configured_returns_501(self, api_client, db) -> None:
        with override_settings(
            ROOT_URLCONF=TEST_URL_CONF,
            TRADINGVIEW_TA_WEBHOOK_TOKEN="",
        ):
            response = api_client.post(
