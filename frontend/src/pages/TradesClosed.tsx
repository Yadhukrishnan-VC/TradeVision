...
export function TradesClosed() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Closed Trades</h1>
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">GET /dashboard/trades/closed/</p>
      </div>
      {state === "error" && error && (
